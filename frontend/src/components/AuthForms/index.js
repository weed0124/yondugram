...
export const LoginForm = props => (
    <div className={styles.formComponent}>
        ...
        <span className={styles.faceookLink}>
            <Ionicon icon="logo-facebook" fontSize="20px" color="#385185" />Log in with Facebook</span>
...
export const SignupForm = props => (
    <div className={styles.formComponent}>
        ...
        <form className={styles.form}>
            ...
            <input type="username" value="Username" className={styles.textInput}/>
            <input type="password" placeholder="Password" className={styles.textInput}/>
